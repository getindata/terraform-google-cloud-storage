...
<!-- BEGIN_TF_DOCS -->
Terraform module for GCP Cloud Storage management.
...
| <a name="descriptor_name"></a> [descriptor\_descriptor_name](#input\_descriptor\_descriptor_name) | Name of the descriptor used to form a resource name | `string` | `"test"` | no |
